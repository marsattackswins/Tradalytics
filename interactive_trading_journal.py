...
# Add streak blocks below the main summary
col_left_blocks, col_winrate2, col_pnl2, col_avg_trades2, col_right_blocks = st.columns([2,1.2,1.2,1.2,2])

with col_left_blocks:
...
st.subheader("Cumulative Win/Loss Count")
...
fig_drawdown.add_shape(type="line", x0=1, x1=len(df), y0=0, y1=0, line=dict(color="white", width=1.5, dash="dash"))
